...
async function openFileStream(): Promise<void> {
    try {
        ...
        console.error(colors.red(`[Logger Error] Failed to open file stream: ${(err as Error).message}`));
    }
}
...
async function writeLog(msg: string): Promise<void> {
    try {
        ...
        console.error(colors.red(`[Logger Error] Failed to write log: ${(err as Error).message}`));
    }
}
...
export async function init(logFilePath: string): Promise<void> {
    try {
        ...
        console.error(colors.red(`[Logger Error] Failed to initialize logger: ${(err as Error).message}`));
    }
}
...
export async function close(): Promise<void> {
    try {
        ...
        console.error(colors.red(`[Logger Error] Failed to close logger: ${(err as Error).message}`));
    }
}
...
export async function info(msg: string): Promise<void> {
    ...
    try {
        ...
        console.error(colors.red(`[Logger Error] Failed to log info message: ${(err as Error).message}`));
    }
}
...
export async function error(msg: string): Promise<void> {
    ...
    try {
        ...
        console.error(colors.red(`[Logger Error] Failed to log error message: ${(err as Error).message}`));
    }
}
